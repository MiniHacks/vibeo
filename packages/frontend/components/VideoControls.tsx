        ...
        >
          ...
          >
            {isPaused ? (
              ...
              >
                <path
                  d="M9 0C4.0275 0 0 4.0275 0 9C0 13.9725 4.0275 18 9 18C13.9725 18 18 13.9725 18 9C18 4.0275 13.9725 0 9 0ZM6.75 4.5L13.5 9L6.75 13.5V4.5Z"
                  fill="black"
                />
              </motion.svg>
            ) : (
